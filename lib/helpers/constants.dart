...
const String demoMunicipio = 'Tijuana';
const String demoBreadcrumb = 'Mexico > Baja California > Tijuana';
...
// Coordenadas demo
const double tijuanaLat = 32.5027;
const double tijuanaLng = -117.0037;
