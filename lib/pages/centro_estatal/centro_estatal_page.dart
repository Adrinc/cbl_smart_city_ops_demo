      ...
      child: Column(
        ...
        children: [
          SectionHeader(
            ...
            subtitle:
                'Coordinación de 5 municipios · SLA regional ${kpi.cumplimientoSla.toStringAsFixed(1)}%',
          ...
          // Municipios + Alertas — responsivo
          TwoColumnLayout(
            left: _MunicipiosCard(kpi: kpi, theme: theme),
  ...
  Widget build(BuildContext context) {
    ...
    return _Card(
      child: Column(
        ...
        children: [
          _CardHeader(
              title: 'Municipios — Baja California Norte',
            ...
            return Container(
              ...
              child: Padding(
                padding: EdgeInsets.symmetric(
                    vertical: 10, horizontal: isDemo ? 8.0 : 0.0),
                child: Row(children: [
                  Expanded(
                      flex: 3,
                      child: Column(
