"""
Crea lib/widgets/shared/responsive_layout.dart
Widget helpers para layouts responsivos: _KpiGrid, TwoColumnLayout, etc.
"""
import pathlib
...
out = ROOT / 'lib' / 'widgets' / 'shared' / 'responsive_layout.dart'
